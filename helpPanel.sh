...
echo -e "	$mC -n $eC Escanea vecinos en una interfaz usando ping para mostrar su ip y su direccion MAC\n"
echo -e "		ej. $bllC ./subnets.sh $eC-n enp0s3 \n"
